...
public class MailSenderService {
	...
	public String joinEmail(String email) {
		...
		String setFrom = "ribbon7675@naver.com"; 						// email-config에 설정한 발신용 이메일 주소 입력.
		...
		return Integer.toString(authNum); // 컨트롤러한테 정수를 문자열로 리턴
	}
	...
	private void mailSend(String setFrom, String toMail, String title, String content) {
		...
		try {
			...
			// true -> HTML 형식으로 전송, 값을 안 주면 단순 텍스트로 전달.
